...
function initSimulation() {
  ...
  predatorDeathRate = parseFloat(document.getElementById('predatorDeathRate').value);
  preyLifeRate = parseFloat(document.getElementById('preyLifeRate').value);
